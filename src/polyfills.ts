...
// const targets = [WebSocket.prototype, HTMLElement, HTMLImageElement];
// targets.forEach((target) => {
//   global['__Zone_ignore_on_properties'].push({
//     target,
//     ignoreProperties: ['close', 'error', 'open', 'message', 'load', 'mouseenter', 'mousemove']
//   });
// });

// // disable addEventListener
// global['__zone_symbol__BLACK_LISTED_EVENTS'] = ['message', 'load', 'mouseenter', 'mousemove'];
 ...
 */
//var originalTimers = require('timers');
//(global as any).originalTimers = originalTimers;
